...
EXP=test_${date}
FLAG_IRRIG=false
CASENAME=$COMPSET.$RES.$SCEN.spunup2
...
NSUBMIT=29  #24 # partition into smaller chunks, excludes the first submission
STARTYEAR=1985
ENDYEAR=2014
...
! daily data - per pft
hist_fincl4 = "QROOTSINK", "TOTSOILLIQ","TOTSOILICE", "SOILWATER_10CM",  "QINFL" , "QOVER", "QDRAI",'EFLX_LH_TOT', 'QIRRIG_FROM_SURFACE', 'H2OSOI',"watsat", "watfc","QSOIL","QVEGE","QVEGT","TLAI","QHR","SMP", "TSA", "TG","RAIN", "SOILLIQ"
