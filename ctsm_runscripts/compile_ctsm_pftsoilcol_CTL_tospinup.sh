...
hist_fincl1 = "QROOTSINK", "watsat", "watfc", "EFF_POROSITY", "SOILPSI"
hist_fincl2 = "QROOTSINK", "TOTSOILLIQ","TOTSOILICE", "SOILWATER_10CM",  "QINFL" , "QOVER", "QDRAI", "ZWT", "FH2OSFC",'EFLX_LH_TOT', 'QIRRIG_FROM_SURFACE', 'H2OSOI',"watsat", "watfc","EFF_POROSITY", "SOILPSI","QSOIL","QVEGE","QVEGT","TLAI","FPSN","QHR","SMP","GSSHA","GSSUN"
