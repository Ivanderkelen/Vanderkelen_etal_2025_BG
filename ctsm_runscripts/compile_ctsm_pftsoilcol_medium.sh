...
SCEN=medium # scenario
EXP=pftsoilcol
FLAG_IRRIG=true
CASENAME=$COMPSET.$RES.$EXP.$SCEN.spunup5
...
NSUBMIT=19  #24 # partition into smaller chunks, excludes the first submission
STARTYEAR=1995
ENDYEAR=2014
...
! finidat='/scratch/snx3000/ivanderk/processing_4p1000/initdata_4p1000/IHistClm51Sp.hcru_hcru_mt13.pftsoilcol.CTL.clm2.r.2035-01-01-00000.nc'
! finidat='/scratch/snx3000/ivanderk/processing_4p1000/initdata_4p1000/IHistClm51Sp.hcru_hcru_mt13.pftsoilcol.CTL.spunup2.clm2.r.2009-01-01-00000.nc'
finidat="/scratch/snx3000/ivanderk/processing_4p1000/initdata_4p1000/IHistClm51Sp.hcru_hcru_mt13.pftsoilcol.$SCEN.spunup4.clm2.r.1992-01-01-00000.nc"
...
! daily data - full grid cell
! hist_fincl3 = "QROOTSINK", "TOTSOILLIQ","TOTSOILICE", "SOILWATER_10CM",  "QINFL" , "QOVER", "QDRAI", 'EFLX_LH_TOT', 'QIRRIG_FROM_SURFACE', 'H2OSOI',"watsat", "watfc","RAIN","QSOIL","QVEGE","QVEGT","TLAI","QHR","SMP", "TSA", "TG", "TSOI", "SOILLIQ"

! daily data - per pft
! hist_fincl4 = "QROOTSINK", "TOTSOILLIQ","TOTSOILICE", "SOILWATER_10CM",  "QINFL" , "QOVER", "QDRAI",'EFLX_LH_TOT', 'QIRRIG_FROM_SURFACE', 'H2OSOI',"watsat", "watfc","QSOIL","QVEGE","QVEGT","TLAI","QHR","SMP", "TSA", "TG", "TSOI", "RAIN", "SOILLIQ"
